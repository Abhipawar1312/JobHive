        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className={`flex items-center justify-center gap-2 p-3 rounded-xl border cursor-pointer transition-all ${selectedRole === "student"
              ...
              <label className={`flex items-center justify-center gap-2 p-3 rounded-xl border cursor-pointer transition-all ${selectedRole === "recruiter"
                  ? "border-[#6A38C2] bg-purple-50/50 dark:bg-purple-950/40 text-[#6A38C2] dark:text-purple-300 font-bold shadow-sm"
                  : "border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 font-medium hover:border-gray-300"
                }`}>
                <input
          ...
          <div className="space-y-1.5">
            <Label className="text-xs font-semibold text-gray-700 dark:text-gray-300">
              {selectedRole === "recruiter" ? "Full Name / Company Representative" : "Full Name"}
            </Label>
            <div className="relative">
              <User className="w-4 h-4 text-gray-400 absolute left-3.5 top-1/2 -translate-y-1/2" />
              <Input
                type="text"
                placeholder={selectedRole === "recruiter" ? "e.g. Alex Morgan (HR Partner)" : "e.g. Alex Johnson"}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  type="email"
                  placeholder={selectedRole === "recruiter" ? "recruiter@company.com" : "candidate@example.com"}
                  {...register("email", {
